    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-12 text-left">
                <!-- <h1 class="font-weight-light" style="color:#FF3C3C;text-shadow: 2px 2px 4px #000000;"><?= $panduanaplikasi['title']; ?></h1> -->
...
<div class="container">
    <div class="content">
        <div class="title">
            <h4 class="h5"><?= $panduanaplikasi['title']; ?></h4>
        </div>
        <p class="description"><?= $panduanaplikasi['description']; ?></p>
        <?php if ($panduanaplikasi['file_document']) { ?>
            <div class="container">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="<?= base_url('uploads/file/pdf' . "/" . $panduanaplikasi['file_document']); ?>" allow="autoplay"></iframe>
                </div>
            </div>
        <?php } else { ?>
            <div></div>
